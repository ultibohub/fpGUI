...
%myfpc%\fpc.exe -dAGGCanvas -dRPI -B -Tultibo -Parm -CpARMV6 -O2 -WpRPiB @%myfpc%\RPI.CFG @extrafpc.cfg agg_canvas_test_ultibo.lpr

:armv7board

%myfpc%\fpc.exe -dAGGCanvas -dRPI2 -B -Tultibo -Parm -CpARMV7A -O2 -WpRPi2B @%myfpc%\RPI2.CFG @extrafpc.cfg agg_canvas_test_ultibo.lpr
