...
{Ultibo version of the AggCanvas example

 Compile using the build_ultibo.bat file in this folder
 
}

program agg_canvas_test_ultibo;
...
//  Canvas.DrawLine(1,y, 10, y);
  ...
  //Canvas.DrawString(5, y, 'Russian (UTF-8) text: Невозможно создать директорию'); //Ultibo To Do //Needs FreeType
  y := y + Canvas.Font.Height;
...
begin
  try 
   Sleep(10000);
   LoggingOutput('Starting fpGUI AGGCanvas'); 
