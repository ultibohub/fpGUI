...
%myfpc%\fpc.exe -dRPI -B -Tultibo -Parm -CpARMV6 -O2 -WpRPiB @%myfpc%\RPI.CFG @extrafpc.cfg fpgcanvas_ultibo.lpr

:armv7board

%myfpc%\fpc.exe -dRPI2 -B -Tultibo -Parm -CpARMV7A -O2 -WpRPi2B @%myfpc%\RPI2.CFG @extrafpc.cfg fpgcanvas_ultibo.lpr
