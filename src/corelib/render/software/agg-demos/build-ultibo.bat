...
REM Lion
%myfpc%\fpc.exe -dRPI -B -Tultibo -Parm -CpARMV6 -O2 -WpRPiB @%myfpc%\RPI.CFG @extrafpc.cfg lion.dpr

REM Other demos to be added here

:armv7board

REM Lion
%myfpc%\fpc.exe -dRPI2 -B -Tultibo -Parm -CpARMV7A -O2 -WpRPi2B @%myfpc%\RPI2.CFG @extrafpc.cfg lion.dpr
